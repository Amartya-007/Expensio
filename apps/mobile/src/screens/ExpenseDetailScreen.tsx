  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={s.backText}>Back to Expenses</Text>
      </Pressable>
...
const s = StyleSheet.create({
  ...
  loadingShell: { flex: 1, backgroundColor: '#f8f9ff', paddingHorizontal: 16 },
  loadingText: {
    fontSize: 14,
    fontWeight: '500',
  ...
  backRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 4 },
  backBtnCircle: {
    width: 40,
    height: 40,
    borderRadius: 12,
  ...
  splitChipPayer: { backgroundColor: '#ecfdf5', borderColor: '#a7f3d0' },
  splitChipNormal: { backgroundColor: '#f8f9ff', borderColor: '#e2e8f0' },
  splitAvatar: {
    width: 20,
    height: 20,
    borderRadius: 10,
  ...
  splitAvatarTextNormal: { color: '#434655' },
  splitName: {
    fontSize: 12,
    fontWeight: '600',
    fontFamily: 'Inter_600SemiBold',
  ...
  sendBtn: { height: 44, paddingHorizontal: 16, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  ...
  editBtnPressed: { backgroundColor: '#f1f5f9' },
  editBtnText: {
    fontSize: 14,
    fontWeight: '600',
    fontFamily: 'Inter_600SemiBold',
  ...
  deleteBtnPressed: { backgroundColor: '#ffb4ab' },
  deleteBtnText: {
    fontSize: 14,
    fontWeight: '600',
    fontFamily: 'Inter_600SemiBold',
